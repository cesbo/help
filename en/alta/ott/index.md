...
There are two kinds of content distributed within an OTT video delivery environment. The first is Video on Demand (VOD) - finished content such as a movie, ready for the consumer to view.
...
The second is called Live Streaming (LIVE) - content such as a sporting event, streaming TV, video from CCTV cameras, for the consumer to view in real time.
