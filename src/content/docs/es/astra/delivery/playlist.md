...
Astra genera una lista de reproducción simple con enlaces a todos los canales habilitados. Esta lista de reproducción sólo está disponible para la función [HTTP Play](/es/astra/delivery/http-hls/http-play).

![Configuración de HTTP Play](https://cdn.cesbo.com/help/astra/delivery/http-hls/playlist/http-play.png)

## Formato de la lista de reproducción[](/es/astra/delivery/http-hls/playlist#playlist-format)
...
## Enlaces a la lista de reproducción[](/es/astra/delivery/http-hls/playlist#links-to-the-playlist)
...
## Grupos de canales[](/es/astra/delivery/http-hls/playlist#channel-groups)

Para una mejor navegación, los canales de la lista de reproducción podrían agruparse. Para ello, cree una nueva categoría en Configuración -> Grupos. Más información sobre cómo crear grupos [de canales](/es/astra/admin-guide/settings/channel-groups).
...
## Canal Logos[](/es/astra/delivery/http-hls/playlist#channel-logos)
...
## Guía electrónica de programas[](/es/astra/delivery/http-hls/playlist#electronic-program-guide)
...
La línea se añadirá a la cabecera de la lista de reproducción y proporcionará información sobre la ubicación de la EPG. Esta URL es sólo un ejemplo, puede utilizar cualquier otra fuente de EPG o explorar nuestra solución, [EPG Aggregator](/es/astra/admin-guide/stream/epg).
