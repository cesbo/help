...
## Ventajas del DVB-CI externo[](/es/astra/receiving/external-ci#advantages-of-external-dvb-ci)
...
## Configuración Astra[](/es/astra/receiving/external-ci#astra-configuration)
...
## Solución de problemas[](/es/astra/receiving/external-ci#troubleshooting)
