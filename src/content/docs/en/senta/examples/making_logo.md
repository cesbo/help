...
First, you need to add a profile for the logo. Go to the [ffmpeg profiles](/en/senta/profiles) tab and click [load profile from github](/en/senta/profiles/loading-from-github). Then, when you find `Logo adding` profile and add it.
