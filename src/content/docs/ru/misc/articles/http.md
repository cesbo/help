...
## HTTP для цифрового телевидения[](/ru/misc/articles/protocols/http#http-for-digital-tv)
...
## Рабочий процесс HTTP MPEG-TS[](/ru/misc/articles/protocols/http#http-mpeg-ts-workflow)
...
## Преимущества HTTP MPEG-TS[](/ru/misc/articles/protocols/http#advantages-of-http-mpeg-ts)
...
## Недостатки HTTP MPEG-TS[](/ru/misc/articles/protocols/http#disadvantages-of-http-mpeg-ts)
