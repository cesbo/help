...
## Интеграция с InfluxDB[](/ru/astra/admin-guide/settings#influxdb-integration)
...
Подробное руководство приведено в разделе [Интеграция Astra с InfluxDB](/ru/astra/monitoring/influxdb)

## Мониторинг[](/ru/astra/admin-guide/settings#monitoring)
...
Подробнее в: [Мониторинг экспорта События](/ru/astra/monitoring/export-monitoring-events)

## Параметры HTTP-сервера[](/ru/astra/admin-guide/settings#http-server-options)
...
Вы можете получить бесплатный сертификат от Let's Encrypt. Подробное руководство приведено в разделе [Сертификат HTTPS с помощью Dehydrated](/ru/misc/tools-and-utilities/dehydrated)

## Параметры потока по умолчанию[](/ru/astra/admin-guide/settings#default-stream-options)
