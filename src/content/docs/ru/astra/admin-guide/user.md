...
## Конфигурация пользователя[](/ru/astra/admin-guide/user#user-configuration)
...
## Получить пользователя[](/ru/astra/admin-guide/user#get-user)
...
## Создание или обновление пользователя[](/ru/astra/admin-guide/user#create-or-update-user)
...
## Удалить пользователя[](/ru/astra/admin-guide/user#remove-user)
...
## Переключить пользователя[](/ru/astra/admin-guide/user#toggle-user)
