...
## Роли пользователей[](/ru/astra/admin-guide/users#user-roles)
...
## Список пользователей[](/ru/astra/admin-guide/users#user-list)
...
## Создание нового пользователя[](/ru/astra/admin-guide/users#new-user)
...
## Встроенная HTTP-аутентификация[](/ru/astra/admin-guide/users#built-in-http-authentication)
