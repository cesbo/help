...
## Интеграция с InfluxDB[](/ru/astra/admin-guide/general#influxdb-integration)
...
## Мониторинг[](/ru/astra/admin-guide/general#monitoring)
...
## Параметры HTTP-сервера[](/ru/astra/admin-guide/general#http-server-options)
...
## Параметры потока по умолчанию[](/ru/astra/admin-guide/general#default-stream-options)
