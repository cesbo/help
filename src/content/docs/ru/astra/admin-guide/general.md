...
## Интеграция с InfluxDB[](/ru/astra/admin-guide/settings/general#influxdb-integration)
...
Подробное руководство приведено в разделе [Интеграция Astra с InfluxDB](/ru/astra/monitoring/export/influxdb)

## Мониторинг[](/ru/astra/admin-guide/settings/general#monitoring)
...
Подробнее в: [Мониторинг экспорта События](/ru/astra/monitoring/export/export-monitoring-events)

## Параметры HTTP-сервера[](/ru/astra/admin-guide/settings/general#http-server-options)
...
Вы можете получить бесплатный сертификат от Let's Encrypt. Подробное руководство приведено в разделе [Сертификат HTTPS с помощью Dehydrated](/ru/misc/tools-and-utilities/network/dehydrated)

## Параметры потока по умолчанию[](/ru/astra/admin-guide/settings/general#default-stream-options)
