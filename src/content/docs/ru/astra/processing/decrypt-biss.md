...
## Прием скремблированного канала[](/ru/astra/processing/decrypt-biss#receiving-a-scrambled-channel)
...
## Ретрансляция скремблированных каналов[](/ru/astra/processing/decrypt-biss#retransmitting-scrambled-channels)
